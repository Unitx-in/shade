...
sealed class ShadeError {
     ...
     */
    object NotConfigured : ShadeError()

    /** An action was dispatched that Shade does not recognise. */
    object UnsupportedAction : ShadeError()
